...
<div id="scrollable-canvas-container">
    <canvas id="Leetcode_canvas-canvas" width="1785" height="2000"></canvas>
</div>
`);
...
describe('Leetcode_canvas Paintbrush Functionality', () => {
    let colorPicker;
    let brushSizePicker;
    let canvas;
    ...
    beforeEach(() => {
        ...
        canvas = document.getElementById('Leetcode_canvas-canvas');
    });
